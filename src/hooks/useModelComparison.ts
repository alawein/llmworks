...
export const MODEL_COMPARISON_DATA_NOTICE =
  'Illustrative sample data — not measured results or provider-backed benchmarks.';

// Deliberately local sample data for the comparison UI. It is not benchmark output.
...
function generatePDFContent(models: ModelData[]): string {
  ...
  return `<!DOCTYPE html><html><head><title>Illustrative LLM Comparison Report</title>
...
<h1>Illustrative LLM Model Comparison Report</h1>
<p><strong>${MODEL_COMPARISON_DATA_NOTICE}</strong></p>
...
<div class="footer">Illustrative sample report generated by LLMWorks - llmworks.dev</div>
</body></html>`;
}
